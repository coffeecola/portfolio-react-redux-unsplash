...
const Main = ({ liked, results, query, titlePage, history }) => {
  // const { liked, results, query, titlePage } = props;
  ...
  const handleSubmit = () => {
    unsplash.search
      ...
      .then(({ results }) => {
        ...
        if (titlePage === "Favorites") history.push("/");
      });
  };
  ...
  let infiniteScroll = titlePage === "Daily Pictures" ? true : false;
  return (
    <React.Fragment>
      <SearchInput
